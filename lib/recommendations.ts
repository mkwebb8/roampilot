...
export function recommendTrips(all:Trip[],filters:DiscoverFilters){return all.filter(t=>t.driveMinutes<=filters.maxDriveHours*60+20).map(t=>scoreTrip(t,filters)).sort((a,b)=>b.score-a.score)}
